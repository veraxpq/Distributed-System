...
public interface Messenger extends Remote, Serializable {
     ...
     */
    void register(String UID, Server server) throws RemoteException;
     ...
     * @throws RemoteException
     */
    void onResolution(ProposalID proposalID, Object value, Client client) throws RemoteException;
}
